...
public:
	...
	void initialise(double kk, Parameters para, std::normal_distribution<>, std::normal_distribution<>, std::normal_distribution<>,
		std::gamma_distribution<> finds, std::uniform_real_distribution<>, std::uniform_real_distribution<>);
	void initialise(double kk, Parameters para, std::normal_distribution<>, std::normal_distribution<>, std::normal_distribution<>,
		std::gamma_distribution<> finds, std::uniform_real_distribution<>, std::uniform_real_distribution<>, std::normal_distribution<>,
	...
	void delet_mutation(int, double,  std::uniform_real_distribution<>, std::gamma_distribution<>);
	...
	void outOffs(Parameters para, int r, int g, std::ofstream* out); //offspring output
